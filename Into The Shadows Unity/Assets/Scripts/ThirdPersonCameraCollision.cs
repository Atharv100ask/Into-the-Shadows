...
public class PlayerCameraCollision : MonoBehaviour
{
    ...
    public float maxDistance = 3.0f;   // Ideal camera distance
    public float minDistance = 0.5f;   // How close camera can come
    public float smoothSpeed = 10f;    // Lerp speed for smooth motion
    public float camHeightOffset = 1.5f; // How high above the player the ray starts
